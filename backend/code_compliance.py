...
LINE_ITEM_CODE_MAP = {
    ...
    "SDG VNYL|r&r": {
        ...
        "supplement_argument": "Siding installation requires compliance with R703.3 AND manufacturer installation instructions per R703.1. A code-compliant installation includes: house wrap (R703.2), wall flashing at all intersections (R703.4), and proper attachment per Table R703.3.2. Partial siding replacement that doesn't maintain weather barrier continuity does not meet code requirements.",
    ...
    "SDG ALUM|r&r": {
        ...
        "supplement_argument": "Aluminum siding installation must comply with R703.3 AND manufacturer specs per R703.1. House wrap (R703.2) and wall flashing (R703.4) are mandatory components.",
        "manufacturer_specs": [],
    },
    "SDG WD|r&r": {
        "section": "R703.3",
        ...
        "requirement": "Siding must be installed per manufacturer instructions AND R703.1. Attachment per Table R703.3.2.",
        "supplement_argument": "Wood siding installation must comply with R703.3. House wrap (R703.2) and wall flashing (R703.4) are mandatory. Cedar requires back-priming per most manufacturer specs.",
        "manufacturer_specs": [],
    },
    "SDG FBRCEM|r&r": {
        "section": "R703.3",
