...
export const SAMPLE_COMPARISON_ROWS: ScopeComparisonRow[] = [
  ...
  },
  {
    ...
    carrier_notes: "Carrier underscoped by 24 LF",
    matched_by: "description",
    status: "under",
    note: "Carrier scoped 187 LF — should be 211 LF per EagleView. Architectural shingle roofs require manufacturer-specified hip/ridge cap shingles, not cut field shingles.",
    code_citation: {
      code_tag: "MFR",
      section: "GAF Timberline HDZ Installation Guide",
      title: "Hip and ridge cap requirement",
      requirement:
        "Use only GAF-approved hip and ridge cap shingles (TimberTex, Seal-A-Ridge, or Ridglass) on Timberline HDZ roofs. Cut field shingles for hip/ridge are not approved and void the manufacturer warranty.",
      supplement_argument:
        "Architectural laminate roof requires factory-made hip/ridge cap. Cut shingles are not warranty-compliant. Carrier's 187 LF figure also undercounts the actual hip + ridge LF measured by EagleView at 211 LF.",
      manufacturer_specs: [
        {
          manufacturer: "GAF",
          document: "Timberline HDZ Installation Guide",
          requirement: "Factory-made hip/ridge cap shingles required (TimberTex, Seal-A-Ridge, or Ridglass).",
          warranty_void: true,
          warranty_text: "Cut field shingles for hip/ridge cap voids the GAF Golden Pledge warranty.",
        },
      ],
      has_warranty_void: true,
      jurisdiction: "Binghamton, NY (RCNYS 2020) + manufacturer spec",
    ...
    irc_code: "RCNYS R905.2.7",
    supplement_argument: "Manufacturer-mandated factory hip/ridge cap.",
    carrier_trick: "manufacturer_omission",
    trick_flag: "high",
    qty_variance: "+24 LF",
    price_variance: "",
  ...
  },
  {
    ...
    matched_by: "missing",
    status: "missing",
    note: "Step flashing must be R&R when shingles are removed — cannot be re-embedded to code-compliant pattern.",
    code_citation: {
      code_tag: "RCNYS",
      section: "R903.2",
      title: "Flashings",
      requirement:
        "Flashings shall be installed in such a manner so as to prevent moisture entering the wall and roof through joints in copings, through moisture-permeable materials, at intersections with parapet walls and other penetrations through the roof plane.",
      supplement_argument:
        "Step flashing is woven into shingle courses during installation. When shingles are removed, the step flashing is either destroyed or its sealing pattern is broken. Re-embedding old flashing into new shingles cannot achieve the original code-compliant water-shedding geometry. R&R is the only code-compliant repair method.",
      manufacturer_specs: [],
      has_warranty_void: false,
      jurisdiction: "Binghamton, NY (RCNYS 2020)",
    },
    irc_code: "RCNYS R903.2",
    supplement_argument: "Code-compliant repair requires R&R, not reset.",
    carrier_trick: "reset_vs_replace",
    trick_flag: "high",
    qty_variance: "",
    price_variance: "",
    unit_mismatch: "",
  ...
  },
  {
    ...
    matched_by: "missing",
    status: "missing",
    note: "Apron and counter-flashing at chimney + wall abutments — omitted from carrier scope entirely.",
    code_citation: {
      code_tag: "RCNYS",
      section: "R903.2",
      title: "Flashings (chimney + wall abutments)",
      requirement:
        "Flashings shall be installed at wall and roof intersections, at gutters, wherever there is a change in roof slope or direction, and around roof openings.",
      supplement_argument:
        "Apron and counter-flashing at chimneys and wall abutments are explicitly required by R903.2. Carrier's omission of any line item for counter-flashing is a clear scope gap — these flashings cannot be reused once shingles are removed because the seal is broken.",
      manufacturer_specs: [],
      has_warranty_void: false,
      jurisdiction: "Binghamton, NY (RCNYS 2020)",
    },
    irc_code: "RCNYS R903.2",
    supplement_argument: "Code-mandated at all roof-to-wall transitions.",
    carrier_trick: "code_omission",
    trick_flag: "high",
    qty_variance: "",
    price_variance: "",
    unit_mismatch: "",
