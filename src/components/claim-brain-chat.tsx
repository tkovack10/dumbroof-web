            ...
            <>
              {editing ? (
                ...
                <>
                  ...
                  {expanded && (
                    // Renders an email body_html generated by claim_brain_email.py
                    // (trusted backend template, NOT LLM output). Markdown LLM
                    // rendering uses <MarkdownContent>; this path is for HTML
                    // email previews only.
