      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-8 pl-10 lg:pl-0">
          ...
          <p className="text-[var(--gray-muted)] mt-1 text-sm">
            Branding, integrations, and company configuration.
          </p>
        </div>
        <div className="glass-card p-12 text-center">
          ...
          <p className="text-lg font-semibold text-[var(--white)] mb-1">Company Settings — Coming Soon</p>
          <p className="text-sm text-[var(--gray-dim)]">
            Company branding, logo upload, API integrations, team invites, and billing management.
          </p>
        </div>
      </div>
    </div>
