...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    // OG image is generated by the dynamic src/app/opengraph-image.tsx route
    // (the old static /og-image.png never existed → broken unfurls).
  },
  twitter: {
...
// Org + WebSite + SoftwareApplication JSON-LD are built from the shared SEO
// registry (src/lib/seo). The SoftwareApplication offers stay faithful to the
// real public pricing (AggregateOffer from PLANS). No aggregateRating is
// emitted — there are no on-page reviews to back a rating.
